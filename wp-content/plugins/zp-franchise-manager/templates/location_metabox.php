<table>
    ...
    <tr valign="top">
        <th class="metabox_label_column">
            <label for="meta_i">Salon Ultimate ID#</label>
        </th>
        <td>
            <input type="text" id="meta_i" name="meta_i" value="<?php echo @get_post_meta($post->ID, 'meta_i', true); ?>" />
        </td>
    </tr>
    <tr valign="top">
        <th class="metabox_label_column">
            <label for="meta_j">Map Shortcode</label>
        </th>
        <td>
            <input type="text" id="meta_j" name="meta_j" value="<?php echo @get_post_meta($post->ID, 'meta_j', true); ?>" />
        </td>
    </tr>
    <tr valign="top">
        <th class="metabox_label_column">
            <label for="meta_k">Google Calendar Code</label>
        </th>
        <td>
            <input type="text" id="meta_k" name="meta_k" value="<?php echo @get_post_meta($post->ID, 'meta_k', true); ?>" />
        </td>
    </tr>
</table>
